...
app.post(
  "/handleCustomerLogin",
  index_controller.handleCustomerLogin,
  redirectBack
);
...
app.post(
  ...
  index_controller.handleCustomerRegister,
  redirectBack
);
app.get("/customerInfo", index_controller.customerInfo, redirectBack);
app.post(
  "/handleUpdateCustomerInfo",
  index_controller.handleUpdateCustomerInfo,
  redirectBack
);
...
app.get(
  ...
  admin_controller.handleDeleteItem,
  redirectBack
);
app.get("/handleReset", admin_controller.handleReset, redirectBack);
app.post(
  "/handleCreatePrize",
  admin_controller.handleCreatePrize,
  redirectBack
);
...
app.post(
  "/handleUpdateProduct",
  admin_controller.handleUpdateProduct,
  redirectBack
);
app.get(
  "/handleDeleteProduct/:product_id",
  admin_controller.handleDeleteProduct,
  redirectBack
);
app.post(
  "/handleCreateProduct",
  admin_controller.handleCreateProduct,
  redirectBack
);
...
app.get(
  "/handleDeleteFaq/:faq_id",
  admin_controller.handleDeleteFaq,
  redirectBack
);
...
app.post(
  ...
  admin_controller.handleUpdateOrderStatus,
  redirectBack
);
